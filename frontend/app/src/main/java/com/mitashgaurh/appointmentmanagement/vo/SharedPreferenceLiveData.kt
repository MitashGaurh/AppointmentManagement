...
abstract class SharedPreferenceLiveData<T>(
    val mSharedPrefs: SharedPreferences, private val mKey: String, private val mDefValue: T
) : LiveData<T>() {
...
class SharedPreferenceIntLiveData(sharedPrefs: SharedPreferences, key: String, defValue: Int) :
    ...
    override fun getValueFromPreferences(key: String, defValue: Int): Int =
        mSharedPrefs.getInt(key, defValue)
}
...
class SharedPreferenceStringLiveData(
    ...
    override fun getValueFromPreferences(key: String, defValue: String): String =
        mSharedPrefs.getString(key, defValue).toString()
}
...
class SharedPreferenceStringSetLiveData(
    ...
    override fun getValueFromPreferences(key: String, defValue: Set<String>): Set<String> =
        mSharedPrefs.getStringSet(key, defValue) as Set<String>
}
