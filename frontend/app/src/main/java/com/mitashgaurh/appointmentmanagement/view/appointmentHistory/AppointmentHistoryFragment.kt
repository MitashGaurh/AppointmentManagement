...
class AppointmentHistoryFragment : BackHandledFragment(), Injectable {
    ...
    private var mAppointmentHistoryAdapter by autoCleared<AppointmentHistoryAdapter>()
    ...
    private fun initRecyclerView() {
        ...
        mAppointmentHistoryAdapter = adapter
        ...
        mAppointmentHistoryViewModel.mAppointmentHistoryLiveData.observe(
            ...
            Observer {
                if (it.status == Status.SUCCESS && null != it.data && it.data.isNotEmpty()) {
                    ...
                    mAppointmentHistoryAdapter.submitList(it.data)
                } else {
                    mBinding.emptyList = true
                    mAppointmentHistoryAdapter.submitList(emptyList())
                }
            })
    }
